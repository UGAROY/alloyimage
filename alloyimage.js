...
(function (Ps) {
  ...
  window[Ps].prototype = {
    ...
    add: function () {
      ...
      var numberArr = [],
        psLibObj, method, alpha, dx, dy, isFast, channel;
  ...
  window[Ps].module("applyMatrix", function (P) {
    ...
    var M = {
      process: function (imgData, arg) {
        ...
        var template = new P.lib.dorsyMath.Matrix([-2, -4, -4, -4, -2, -4, 0, 8, 0, -4, -4, 8, 24, 8, -4, -4, 0, 8, 0, -4, -2, -4, -4, -4, -2], 25, 1);
        var tempData = [];
        ...
        var Effects = {
          ...
          rough: function () {
            return this.add(
              ...
              window[Ps](this.canvas.width, this.canvas.height, "#000").act("喷点").act("反色").act("浮雕效果"), "叠加"
            );
          }
        };
    ...
    var M = {
      ...
      toText: {
        process: function (imgData, args) {
          ...
          //创建div串
          var i, everyLevel = 255 / str.length,
            j;
